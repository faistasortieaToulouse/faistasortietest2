...
export default function MobilityLayout({
  ...
  // La mise en surbrillance de l'onglet actif est donc désactivée.
    ...
    <div className="flex flex-col gap-6 p-4 md:p-8">
      ...
      <nav className="flex space-x-2 border-b pb-4 overflow-x-auto whitespace-nowrap">
        {mobilityNavItems.map((item) => {
          ...
          // Idéalement, on utiliserait usePathname().
      ...
      {/* Contenu de la sous-page (app/mobility/page.tsx ou app/mobility/map/page.tsx etc.) */}
